...
int TPomodoro = 0;          // Variável com Tempo de Pomodoro em segundos
...
int estado = 0;             // Variavel de controle do codigo
int cont = 0;               // Variavel auxiliar para contagem de tempo
...
void loop() {
  ...
  switch (estado) {
    case 0: //Estado Desligado
      ...
      if (Serial.available()) {
        TPomodoro_aux = Serial.parseInt(); // Tempo de Pomodoro em segundos
